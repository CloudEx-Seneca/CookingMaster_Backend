...
const (
	...
	Usercenter_VarifyToken_FullMethodName   = "/usercenter.Usercenter/VarifyToken"
)
...
func (c *usercenterClient) VarifyToken(ctx context.Context, in *VarifyTokenReq, opts ...grpc.CallOption) (*VarifyTokenResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VarifyTokenResp)
	err := c.cc.Invoke(ctx, Usercenter_VarifyToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsercenterServer) VarifyToken(context.Context, *VarifyTokenReq) (*VarifyTokenResp, error) {
...
func _Usercenter_VarifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VarifyTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsercenterServer).VarifyToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Usercenter_VarifyToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsercenterServer).VarifyToken(ctx, req.(*VarifyTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Usercenter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Usercenter_VarifyToken_Handler,
		},
	},
